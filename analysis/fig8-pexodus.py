...
ax.plot([0,1],[1,1], label="$p^{timing,c_{M}=1}_{exodus}$", color="tab:blue", linestyle="dotted")
...
ax.text(0.75,0.75,FIG_REF+"a", ha="center", va="bottom", fontsize="small")
ax.text(0.5,0.875,FIG_REF+"b", ha="center", va="bottom", fontsize="small")

ax.vlines(.5,0,0.875, linestyle="solid", linewidth=1, color="black")
ax.vlines(.75,0,0.75, linestyle="solid", linewidth=1, color="black")

ax.plot([1,0],[0.5,.5], label="$p^{cuckoo-C,satur,c_{M}=50\\%}_{exodus}$", color="tab:red", linestyle="solid")
...
ax.legend(loc='center left', bbox_to_anchor=(-.3, 1.25),handlelength=1.5, ncols=2, labelspacing=0.25, columnspacing=0.5)
