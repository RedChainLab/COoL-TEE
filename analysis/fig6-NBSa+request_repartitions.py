...
d={ 
    ...
    'ATTACK_TYPE': ['COoL Content attack', 'random Timing attack', 'COoL Timing attack', 'COoL Fault-free', 'PoT Timing attack',
                    'COoL Content attack', 'random Timing attack', 'COoL Timing attack', 'COoL Fault-free', 'PoT Timing attack',],
