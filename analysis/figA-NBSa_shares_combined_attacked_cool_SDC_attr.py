...
from figA_config_attacked_cool_SDC_attr import *
...
d={ 
    ...
    'ATTACK_TYPE': ['RDM', 'COoL-TEE Cuckoo-T', 'T4CT Cuckoo-T', 'RDM-Attr Cuckoo-T', 'COoL-TEE-Attr Cuckoo-T', 'T4CT-Attr Cuckoo-T', 
                    'RDM', 'COoL-TEE Cuckoo-T', 'T4CT Cuckoo-T', 'RDM-Attr Cuckoo-T', 'COoL-TEE-Attr Cuckoo-T', 'T4CT-Attr Cuckoo-T' ],
