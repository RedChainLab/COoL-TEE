...
from figA_config_attacked_cool_atlas import *
...
d={ 
    ...
    'ATTACK_TYPE': ['RDM Timing attack', 'COoL-TEE Timing attack', 'T4CT Timing attack', 
                    'RDM Timing attack', 'COoL-TEE Timing attack', 'T4CT Timing attack'],
