...
from figA7_config_cool_t4ct_atlas_attr import *
...
d={ 
    'CONSUMER_BEHAVIOUR': ['Malicious consumers', 
                            'Honest consumers', ],
    'ATTACK_TYPE': ['COoL-TEE-attr Cuckoo-T attack', 
                    'COoL-TEE-attr Cuckoo-T attack', ],
...
cats=[
            ('Malicious consumers',      'T4CT Atlas attack'),
            (   'Honest consumers',    'T4CT Atlas attack'),
            ]
