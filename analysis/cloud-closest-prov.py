...
fig.savefig(f"{FIG_DIR}/cloud-closest-prov-latency-hist{'-dens' if DENSITY else ''}{'-cumul' if CUMUL else ''}.png")
ax.set_xlim(1)
ax.set_xscale('log')
fig.savefig(f"{FIG_DIR}/cloud-closest-prov-latency-hist{'-dens' if DENSITY else ''}{'-cumul' if CUMUL else ''}-log.png")
