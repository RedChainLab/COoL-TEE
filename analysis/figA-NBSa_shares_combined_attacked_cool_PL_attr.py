...
from figA_config_attacked_cool_PL_attr import *
...
d={ 
    ...
    'ATTACK_TYPE': [ 'RDM-Attr', 'COoL-TEE-Attr', 'T4CT-Attr', 
                     'RDM-Attr', 'COoL-TEE-Attr', 'T4CT-Attr' ],
...
linestyles=["dotted","dashed","dashdot","dashed", "dashed", "dashed"]
